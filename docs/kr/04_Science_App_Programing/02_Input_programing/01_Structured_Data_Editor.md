...
## Datatype 생성
```My EDISON > Datatype 관리 > 추가```를 통해 신규 Datatype을 생성할 수 있습니다.
...
![Datatype의 Editor 지정](../../asset/image/04/02/sde3.png)

## Datatype 편집

### 샘플 데이터 등록
![Datatype의 Editor 지정](../../asset/image/04/02/sde4.png)

우선 해당 Datatype의 샘플 파일을 업로드 해야합니다.

### 데이터 생성 규칙 설정
![Datatype의 Editor 지정](../../asset/image/04/02/sde5.png)
...
![Datatype의 Editor 지정](../../asset/image/04/02/sde6.png)
...
![numeric 타입 생성 화면](../../asset/image/04/02/sde7.png)
...
![string 타입 생성 화면](../../asset/image/04/02/sde8.png)
...
![list 타입 생성 화면](../../asset/image/04/02/sde9.png)
...
![vector 타입 생성 화면](../../asset/image/04/02/sde10.png)
...
![vector 타입 생성 화면](../../asset/image/04/02/sde11.png)
